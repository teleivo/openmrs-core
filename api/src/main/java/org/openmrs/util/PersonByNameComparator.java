...
public class PersonByNameComparator implements Comparator<Person> {
	...
	public static int comparePersonsByName(Person person1, Person person2) {
		...
		if (ret == 0) {
			ret = OpenmrsUtil.compareWithNullAsGreatest(
			    name1.getFamilyNamePrefix() != null ? name1.getFamilyNamePrefix().toLowerCase() : null,
			    name2.getFamilyNamePrefix() != null ? name2.getFamilyNamePrefix().toLowerCase() : null);
		}
		
		if (ret == 0) {
			ret = OpenmrsUtil.compareWithNullAsGreatest(
			    name1.getFamilyNameSuffix() != null ? name1.getFamilyNameSuffix().toLowerCase() : null,
			    name2.getFamilyNameSuffix() != null ? name2.getFamilyNameSuffix().toLowerCase() : null);
		}
