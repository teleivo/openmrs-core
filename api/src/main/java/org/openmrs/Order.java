...
@AttributeOverrides({
	@AttributeOverride(name = "dateChanged", column = @Column(name = "date_changed", insertable = false, updatable = false)),
	@AttributeOverride(name = "changedBy", column = @Column(name = "changed_by", insertable = false, updatable = false))
})
