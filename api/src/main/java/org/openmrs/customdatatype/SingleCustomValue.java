...
public interface SingleCustomValue<D extends CustomValueDescriptor> {
	...
	/**
	 * @return the value persisted in a database in a varchar column. Not necessarily
	 *         human-readable.
	...
	/**
	 * Directly set the String value that OpenMRS should persist in the database in a varchar
	 * column. Implementations should validate this value and throw an
	 * {@link InvalidCustomValueException} if it's invalid, rather than setting it blindly. If you
	 * are coding against the OpenMRS API, you should use {@link #setValue(Object)} instead.
	 * 
	...
	/**
	 * Convenience method to get the typed version of the serializedValue. (This will result in a
	 * call to a {@link CustomDatatype#fromReferenceString(String)}.)
	 * 
