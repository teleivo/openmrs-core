...
public class EncounterSearchCriteriaBuilder {
	...
	/**
	 * @param visits the visits of the encounter must be in this collection. This search parameter
	...
	public EncounterSearchCriteria createEncounterSearchCriteria() {
		return new EncounterSearchCriteria(patient, location, fromDate, toDate, dateChanged, enteredViaForms, encounterTypes,
